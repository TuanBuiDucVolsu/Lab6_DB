...
CREATE TABLE lab6.ShoppingCenter(
...
insert into lab6.shoppingcenter(sname,adress,phonenumber,numberofloor,time_work)
values('Akvarel','volgograd',844226660,3,12);
insert into lab6.shop(id_N,ssname,specialization,place,phone_number,time_work)
...
insert into lab6.entertain_center(rname,location,kind_of_activity,time_work)
...
insert into lab6.sharea(number_of_seats,number_of_free_seat)
values(40,7);
insert into lab6.shop(id_N,ssname,specialization,place,phone_number,time_work)
